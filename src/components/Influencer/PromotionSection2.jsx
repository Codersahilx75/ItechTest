            ...
            <PromotionTable />
              ...
              <div className="container flex flex-col items-center space-y-4 w-full">
                ...
                <textarea
                  ...
                  rows={4}
                  className="prf w-full p-4 text-white rounded-3xl focus:outline-none focus:border-blue-500 resize-none"
                />

                {/* Submit Button */}
                <button
                  className="px-6 py-2 customeBGBlue text-white rounded-lg hover:bg-blue-600 transition duration-300"
                >
                  Submit
                </button>
              </div>
