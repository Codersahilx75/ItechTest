...
function InfluencersProfiles() {
    return (
        <div className="w-full text-white text-center pt-10 lg:pt-20 mt-10 lg:mt-20  relative px-4 backMd">
            <h2 className="text-2xl lg:text-5xl md:text-4xl">
            Influencers <span className="customeBlue font-bold">Profiles</span>
            </h2>
            ...
            <div className="flex justify-center gap-6 lg:space-y-0 space-y-24 md:gap-10 mt-10 flex-wrap">
                {winningData.winners.map((winner, index) => (
                    <div
                        key={index}
                        className="relative p-5 md:p-3 shadow-lg w-full sm:w-72 text-center overflow-visible bg-[#00182D] rounded-3xl"
            ...
            {/* Button */}
            <button className="mt-32 md:mt-38 customeBGBlue text-white px-8 sm:px-8 py-2 sm:py-3 text-base sm:text-lg rounded-lg font-semibold hover:bg-blue-600 transition">
            See More Profiles
            </button>
        </div>
    )
...
export default InfluencersProfiles